...
namespace Guppy.Utilities
{
    ...
    public class PooledFactory
    {
        ...
        {
            if (!_pools.ContainsKey(type)) // If a pool does not alread exist for this type... create it.
                _pools[type] = ActivatorUtilities.CreateInstance(_provider, _poolLoader.GetValue(type), type) as Pool;
