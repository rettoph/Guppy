...
namespace Guppy.Game.ImGui.Extensions
{
    public static class ContainerBuilderExtensions
    {
        public static ContainerBuilder RegisterGameImguiServices(this ContainerBuilder builder)
        {
            if (builder.HasTag(nameof(RegisterGameImguiServices)))
            {
                return builder;
            }
            ...
            return builder.AddTag(nameof(RegisterGameImguiServices));
        }
