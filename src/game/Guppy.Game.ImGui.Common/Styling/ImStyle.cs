...
namespace Guppy.Game.ImGui.Common.Styling
{
    public class ImStyle
    {
        ...
        {
            this._keyedValues.Add(key, new ImStyleVarFloatValue(key, var, value));
        }

        public void Set(string key, ImGuiStyleVar var, Vector2 value)
        {
            this._keyedValues.Add(key, new ImStyleVarVector2Value(key, var, value));
        }

        public void Set(string key, ImGuiCol var, Color color)
        {
            this._keyedValues.Add(key, new ImStyleColorValue(key, var, new Ref<Color>(color)));
        }

        public void Set(string key, ImFontPtr font)
        {
            this._keyedValues.Add(key, new ImStyleFontValue(key, new Ref<ImFontPtr>(font)));
        }

        public void Set(ImGuiStyleVar var, float value)
        {
            this._globalValues.Add(new ImStyleVarFloatValue(null, var, value));
        }

        public void Set(ImGuiStyleVar var, Vector2 value)
        {
            this._globalValues.Add(new ImStyleVarVector2Value(null, var, value));
        }

        public void Set(ImGuiCol var, Color color)
        {
            this._globalValues.Add(new ImStyleColorValue(null, var, new Ref<Color>(color)));
        }

        public void Set(ImFontPtr font)
        {
            this._globalValues.Add(new ImStyleFontValue(null, new Ref<ImFontPtr>(font)));
        }
