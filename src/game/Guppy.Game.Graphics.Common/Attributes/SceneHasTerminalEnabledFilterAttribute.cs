...
{
    public class SceneHasTerminalEnabledFilterAttribute(bool value = true) : GuppyConfigurationAttribute
    {
        ...
        protected override void Configure(IContainer boot, ContainerBuilder builder, Type classType)
        {
            builder.RegisterFilter(new StateServiceFilter<bool>(
                ...
                key: StateKey<bool>.Create(SceneConfigurationKeys.SceneHasTerminalEnabled),
                value: this.Value));
        }
    }
}
