...
namespace Guppy.DependencyInjection
{
    ...
    {
        #region Delegates
        public delegate Boolean MethodDelegate(IEntity entity, GuppyServiceProvider provider, ServiceConfiguration<GuppyServiceProvider> componentConfiguration);
        public delegate Boolean FilterDelegate(ServiceConfiguration<GuppyServiceProvider> componentConfiguration, ServiceConfiguration<GuppyServiceProvider> entityConfiguration);
        #endregion
