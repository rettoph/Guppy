...
namespace Guppy.EntityComponent.DependencyInjection.Builders
{
    ...
    //     public ComponentServiceConfigurationBuilder<TComponent> RegisterComponentConfiguration(Action<ComponentConfigurationBuilder<TComponent>> builder)
    //     {
    //         ComponentConfigurationBuilder<TComponent> componentConfiguration = this.services.RegisterComponent<TComponent>(this.Name);
